...
public class reviewDetailsNetworkUtil {
    static int key;

    public static URL buildUrl(int baseURL) {
        key = baseURL;

        String DetailedMovie = "https://api.themoviedb.org/3/movie/"+key+"/reviews?api_key=18e23d5378804a57dc5743d12472408f&language=en-US";
